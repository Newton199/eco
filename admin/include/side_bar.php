...
<li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-primary" onClick="location.href='clothes_list.php'"><span class="glyphicon glyphicon-edit pull-left"></span> Product Details  </button></li>
 ...
 <li><a href="electronic_list.php"><strong> Electronic List</strong></a></li>
   </ul></li>
...
<li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-danger" onClick="location.href='../admin/login.php'"><span class="glyphicon glyphicon-off pull-left">
