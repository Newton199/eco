...
list($stock)=mysqli_fetch_array($result);
//$path="../product_images/$picture";
...
$result=mysqli_query($con,"select product_id,product_image, product_title,product_price, stock from products  where  product_cat=2 or product_cat=3 or product_cat=4 Limit $page1,10")or die ("query 1 incorrect.....");
...
//counting paging
/*
$paging=mysqli_query($con,"select product_id,product_image, product_title,product_price,stock from products");
