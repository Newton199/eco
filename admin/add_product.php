...
mysqli_query($con,"insert into products (product_cat, product_brand,product_title,product_price, product_desc, product_image,Stock,product_keywords) values ('$product_type','$brand','$product_name','$price','$details','$pic_name','$stock','$tags')") or die ("query incorrect");
...
<br>
<p>Vendor / Brand</p>
<input type="number" name="brand" id="brand" class="form-control" placeholder="1 HP,2 Samsung,3 Apple,4 Lenovo">
<br>
<p>Stock</p>
<input type="number" name="stock" id="stock" class="form-control" placeholder="Add stock number">
<br>
<p>Other tags</p>
